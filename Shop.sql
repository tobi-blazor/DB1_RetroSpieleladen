...
Bestellnummer INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
Kundennummer INTEGER,
Bestelldatum DATE,
...
Pos INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
